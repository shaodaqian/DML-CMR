import torch
import numpy as np
from src.models.PKDR.gps.kde import kde_gps
from src.models.PKDR.gps.normflow import CNF
...
class GPS():
    ...
    def kde_gps(self):
        ...
        return gps
    def cnf_gps(self,device,n_layers,hidden,batch_size,lr,n_epochs,weight_decay,**kwargs):
        """
