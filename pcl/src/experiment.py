...
from src.models.DML_PCL.trainer import dml_pcl_experiments
from src.models.PKDR.experiments import pkdr_experiments
...
def get_run_func(mdl_name: str):
    ...
    elif mdl_name == "dml_pcl":
        return dml_pcl_experiments
    elif mdl_name == "pkdr":
        return pkdr_experiments
    else:
